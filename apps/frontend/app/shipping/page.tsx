...
export const metadata = {
  title: 'Shipping Policy | DSIB Tech',
  description: 'Shipping Policy for DSIB Tech',
};

export default function shippingPage() {
  return (
    <div className="container mx-auto px-4 py-16 min-h-[60vh] flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Shipping Policy</h1>
      <p className="text-lg text-muted-foreground max-w-2xl mb-8">
        We are currently updating our Shipping Policy page with the latest information. 
