...
export const metadata = {
  title: 'Warranty Information | DSIB Tech',
  description: 'Warranty Information for DSIB Tech',
};

export default function warrantyPage() {
  return (
    <div className="container mx-auto px-4 py-16 min-h-[60vh] flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Warranty Information</h1>
      <p className="text-lg text-muted-foreground max-w-2xl mb-8">
        We are currently updating our Warranty Information page with the latest information. 
