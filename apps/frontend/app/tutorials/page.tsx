...
export const metadata = {
  title: 'STEM Tutorials | DSIB Tech',
  description: 'STEM Tutorials for DSIB Tech',
};

export default function tutorialsPage() {
  return (
    <div className="container mx-auto px-4 py-16 min-h-[60vh] flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">STEM Tutorials</h1>
      <p className="text-lg text-muted-foreground max-w-2xl mb-8">
        We are currently updating our STEM Tutorials page with the latest information. 
